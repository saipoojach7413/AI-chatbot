...
@app.route('/lresult', methods=['GET', 'POST'])
def lresult():
    global count
    ...
    if request.method == 'GET':
        ...
        if count == 0:
            ...
            global prevcustomerID
            prevcustomerID = customerid
            return render_template('lresult.html', userprice_list=userprice_list, userprice=userprice, prediction=result,
                                   discountedprice=finalprice)
        elif count == 1:
            disprice = (int(actualprice) * ((result / 100)*(3/4)))
            finalprice = (int(actualprice) - disprice)
            ...
            global prevcustomerID1
            prevcustomerID1 = prevcustomerID
            return render_template('lresult1.html', userprice_list=userprice_list, userprice=userprice, prediction=result,
                                   discountedprice=finalprice)
        else:
            disprice = (int(actualprice) * (result / 100))
            finalprice = (int(actualprice) - disprice)
            ...
            for line in open('data.txt'):
                userprice_list.append(file.readlines())
            count += 1
            return render_template('lresult2.html', userprice_list=userprice_list, userprice=userprice,
                                   prediction=result,
                                   discountedprice=finalprice)



@app.route('/iresult', methods=['GET', 'POST'])
def iresults():
    global count
    ...
    if request.method == 'GET':
        ...
        if count == 0:
            ...
            global prevcustomerID
            prevcustomerID = customerid
            return render_template('iresult.html', userprice_list=userprice_list, userprice=userprice, prediction=result,
                                   discountedprice=finalprice)
        elif count == 1:
            disprice = (int(actualprice) * ((result / 100)*(3/4)))
            finalprice = (int(actualprice) - disprice)
            ...
            global prevcustomerID1
            prevcustomerID1 = prevcustomerID
            return render_template('iresult1.html', userprice_list=userprice_list, userprice=userprice, prediction=result,
                                   discountedprice=finalprice)
        else:
            disprice = (int(actualprice) * (result / 100))
            finalprice = (int(actualprice) - disprice)
            ...
            for line in open('data.txt'):
                userprice_list.append(file.readlines())
            count += 1
            return render_template('iresult2.html', userprice_list=userprice_list, userprice=userprice,
                                   prediction=result,
                                   discountedprice=finalprice)
